...
const translations = {
  ar: {
    ...
    'seo.spotlight.title': 'خطة قبول دراسي مخصصة خلال 24 ساعة',
    'seo.spotlight.lead':
      'نراجع هدفك، نقارن المعاهد، ونبني لك مسارًا واضحًا يناسب مستواك وميزانيتك، مع متابعة يومية حتى إصدار القبول.',
    'seo.spotlight.chip1': 'قبول دراسة اللغة في الفلبين',
    'seo.spotlight.chip2': 'التسجيل في معاهد اللغة للسعوديين',
    'seo.spotlight.chip3': 'برامج اللغة الأكاديمية',
    'seo.spotlight.chip4': 'إرشاد السكن والوصول',
    'seo.spotlight.cta': 'ابدأ الاستشارة المجانية',
    'seo.spotlight.badge': 'قبول أسرع بخطوات واضحة',
    'seo.spotlight.media.alt': 'طلاب سعوديون يدرسون في معهد لغة معتمد في الفلبين',
    'seo.spotlight.card1.alt': 'اختيار معاهد اللغة المعتمدة في الفلبين',
    'seo.spotlight.card1.title': 'اختيار المعهد الأنسب',
    'seo.spotlight.card1.pre': 'نرشح لك أفضل خيار حسب هدفك ومدة الدراسة. اطلع على برامج ',
    'seo.spotlight.card1.link': 'معاهد اللغة',
    'seo.spotlight.card1.post': ' وقارن المسارات بسهولة.',
    'seo.spotlight.card2.alt': 'تجهيز ملف القبول الدراسي والتسجيل في معاهد اللغة',
    'seo.spotlight.card2.title': 'ملف قبول جاهز بدون تعقيد',
    'seo.spotlight.card2.pre': 'نرتب مستنداتك ونتابع المعهد خطوة بخطوة لتقليل التأخير. راجع تفاصيل ',
    'seo.spotlight.card2.link': 'خدماتنا',
    'seo.spotlight.card2.post': ' وابدأ طلبك الآن.',
    'seo.spotlight.card3.alt': 'دعم الطلاب الخليجيين قبل وبعد الوصول إلى الفلبين',
    'seo.spotlight.card3.title': 'دعم قبل وبعد السفر',
    'seo.spotlight.card3.pre': 'نساندك في السكن والوصول والتجهيزات العملية للانطلاق بثقة. تواصل معنا عبر ',
    'seo.spotlight.card3.link': 'نموذج التسجيل',
    'seo.spotlight.card3.post': '.',
  ...
  en: {
    ...
    'seo.spotlight.title': 'Personalized Admission Plan in 24 Hours',
    'seo.spotlight.lead':
      'We review your goal, compare institutes, and build a clear pathway that fits your level and budget, with daily follow-up until admission is issued.',
    'seo.spotlight.chip1': 'Language study admission in the Philippines',
    'seo.spotlight.chip2': 'Institute registration for Saudi students',
    'seo.spotlight.chip3': 'Academic language programs',
    'seo.spotlight.chip4': 'Housing and arrival guidance',
    'seo.spotlight.cta': 'Start your free consultation',
    'seo.spotlight.badge': 'Faster admission with clear steps',
    'seo.spotlight.media.alt':
      'Saudi students studying at an accredited language institute in the Philippines',
    'seo.spotlight.card1.alt': 'Choosing accredited language institutes in the Philippines',
    'seo.spotlight.card1.title': 'Choose the Best-Fit Institute',
    'seo.spotlight.card1.pre':
      'We recommend the best option based on your goal and study duration. Explore ',
    'seo.spotlight.card1.link': 'language institutes',
    'seo.spotlight.card1.post': ' programs and compare tracks with ease.',
    'seo.spotlight.card2.alt': 'Preparing admission file and language institute registration',
    'seo.spotlight.card2.title': 'Admission File Ready Without Complexity',
    'seo.spotlight.card2.pre':
      'We organize your documents and follow up with the institute step by step to reduce delays. Review ',
    'seo.spotlight.card2.link': 'our services',
    'seo.spotlight.card2.post': ' and start your request now.',
    'seo.spotlight.card3.alt':
      'Support for GCC students before and after arriving in the Philippines',
    'seo.spotlight.card3.title': 'Support Before and After Travel',
    'seo.spotlight.card3.pre':
      'We support housing, arrival, and practical preparation so you can start with confidence. Contact us through the ',
    'seo.spotlight.card3.link': 'registration form',
    'seo.spotlight.card3.post': '.',
  ...
  fr: {
    ...
    'seo.spotlight.title': 'Plan d admission personalise en 24 h',
    'seo.spotlight.lead':
      'Nous analysons votre objectif, comparons les instituts et construisons un parcours clair selon votre niveau et votre budget, avec un suivi quotidien jusqu a l admission.',
    'seo.spotlight.chip1': 'Admission en cours de langue aux Philippines',
    'seo.spotlight.chip2': 'Inscription aux instituts de langues pour Saoudiens',
    'seo.spotlight.chip3': 'Programmes de langue academiques',
    'seo.spotlight.chip4': 'Orientation logement et arrivee',
    'seo.spotlight.cta': 'Commencer la consultation gratuite',
    'seo.spotlight.badge': 'Admission plus rapide avec des etapes claires',
    'seo.spotlight.media.alt':
      'Etudiants saoudiens dans un institut de langue accredite aux Philippines',
    'seo.spotlight.card1.alt': 'Choisir les instituts de langue accredites aux Philippines',
    'seo.spotlight.card1.title': 'Choisir l institut le plus adapte',
    'seo.spotlight.card1.pre':
      'Nous proposons la meilleure option selon votre objectif et la duree d etude. Consultez les programmes des ',
    'seo.spotlight.card1.link': 'instituts de langues',
    'seo.spotlight.card1.post': ' et comparez les parcours facilement.',
    'seo.spotlight.card2.alt': 'Preparation du dossier d admission et inscription en institut',
    'seo.spotlight.card2.title': 'Dossier d admission pret sans complexite',
    'seo.spotlight.card2.pre':
      'Nous organisons vos documents et suivons l institut etape par etape pour reduire les retards. Consultez ',
    'seo.spotlight.card2.link': 'nos services',
    'seo.spotlight.card2.post': ' et lancez votre demande maintenant.',
    'seo.spotlight.card3.alt':
      'Accompagnement des etudiants du Golfe avant et apres l arrivee aux Philippines',
    'seo.spotlight.card3.title': 'Support avant et apres le voyage',
    'seo.spotlight.card3.pre':
      'Nous vous accompagnons pour le logement, l arrivee et la preparation pratique afin de commencer en confiance. Contactez nous via le ',
    'seo.spotlight.card3.link': 'formulaire d inscription',
    'seo.spotlight.card3.post': '.',
  ...
  es: {
    ...
    'seo.spotlight.title': 'Plan de admision personalizado en 24 horas',
    'seo.spotlight.lead':
      'Revisamos tu objetivo, comparamos institutos y construimos una ruta clara segun tu nivel y presupuesto, con seguimiento diario hasta emitir la admision.',
    'seo.spotlight.chip1': 'Admision para estudiar idioma en Filipinas',
    'seo.spotlight.chip2': 'Registro en institutos de idioma para saudies',
    'seo.spotlight.chip3': 'Programas academicos de idioma',
    'seo.spotlight.chip4': 'Orientacion de vivienda y llegada',
    'seo.spotlight.cta': 'Empieza la consulta gratuita',
    'seo.spotlight.badge': 'Admision mas rapida con pasos claros',
    'seo.spotlight.media.alt':
      'Estudiantes saudies en un instituto de idioma acreditado en Filipinas',
    'seo.spotlight.card1.alt': 'Seleccion de institutos de idioma acreditados en Filipinas',
    'seo.spotlight.card1.title': 'Elegir el instituto mas adecuado',
    'seo.spotlight.card1.pre':
      'Te recomendamos la mejor opcion segun tu objetivo y duracion de estudio. Revisa los programas de ',
    'seo.spotlight.card1.link': 'institutos de idioma',
    'seo.spotlight.card1.post': ' y compara rutas facilmente.',
    'seo.spotlight.card2.alt': 'Preparacion del expediente de admision y registro en institutos',
    'seo.spotlight.card2.title': 'Expediente de admision listo sin complicaciones',
    'seo.spotlight.card2.pre':
      'Organizamos tus documentos y seguimos al instituto paso a paso para reducir retrasos. Revisa ',
    'seo.spotlight.card2.link': 'nuestros servicios',
    'seo.spotlight.card2.post': ' y empieza tu solicitud ahora.',
    'seo.spotlight.card3.alt':
      'Apoyo a estudiantes del Golfo antes y despues de llegar a Filipinas',
    'seo.spotlight.card3.title': 'Apoyo antes y despues del viaje',
    'seo.spotlight.card3.pre':
      'Te apoyamos en vivienda, llegada y preparacion practica para empezar con confianza. Contactanos mediante el ',
    'seo.spotlight.card3.link': 'formulario de registro',
    'seo.spotlight.card3.post': '.',
  ...
  tr: {
    ...
    'seo.spotlight.title': '24 Saatte Kisisel Kabul Plani',
    'seo.spotlight.lead':
      'Hedefinizi inceliyor, kurumlari karsilastiriyor ve seviyenize ve butcenize uygun net bir yol ciziyoruz; kabul cikana kadar gunluk takip sagliyoruz.',
    'seo.spotlight.chip1': 'Filipinlerde dil egitimi kabul sureci',
    'seo.spotlight.chip2': 'Suudi ogrenciler icin kurum kaydi',
    'seo.spotlight.chip3': 'Akademik dil programlari',
    'seo.spotlight.chip4': 'Konaklama ve varis rehberligi',
    'seo.spotlight.cta': 'Ucretsiz danismanligi baslat',
    'seo.spotlight.badge': 'Net adimlarla daha hizli kabul',
    'seo.spotlight.media.alt':
      'Filipinlerde akredite bir dil kurumunda egitim alan Suudi ogrenciler',
    'seo.spotlight.card1.alt': 'Filipinlerde akredite dil kurumlarini secme',
    'seo.spotlight.card1.title': 'En Uygun Kurumu Secin',
    'seo.spotlight.card1.pre':
      'Hedefinize ve egitim suresine gore en uygun secenegi oneriyoruz. ',
    'seo.spotlight.card1.link': 'Dil kurumlari',
    'seo.spotlight.card1.post': ' programlarini inceleyin ve rotalari kolayca karsilastirin.',
    'seo.spotlight.card2.alt': 'Kabul dosyasi hazirlama ve kurum kaydi sureci',
    'seo.spotlight.card2.title': 'Karmasik Olmadan Hazir Kabul Dosyasi',
    'seo.spotlight.card2.pre':
      'Belgelerinizi duzenliyor ve gecikmeyi azaltmak icin kurumla adim adim takip yapiyoruz. ',
    'seo.spotlight.card2.link': 'Hizmetlerimizi',
    'seo.spotlight.card2.post': ' inceleyin ve basvurunuzu hemen baslatin.',
    'seo.spotlight.card3.alt':
      'Korfez ogrencileri icin Filipinlere varis oncesi ve sonrasi destek',
    'seo.spotlight.card3.title': 'Seyahat Oncesi ve Sonrasi Destek',
    'seo.spotlight.card3.pre':
      'Konaklama, varis ve pratik hazirlik konularinda destek veriyoruz. Guvenle baslamak icin ',
    'seo.spotlight.card3.link': 'kayit formu',
    'seo.spotlight.card3.post': ' uzerinden bize ulasin.',
